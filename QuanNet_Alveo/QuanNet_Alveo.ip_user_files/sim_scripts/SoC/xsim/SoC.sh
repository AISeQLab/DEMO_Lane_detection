...
xvlog_opts="--relax -L axi_vip_v1_1_8 -L smartconnect_v1_0 -L xdma_v4_1_8 -L xilinx_vip"
xvhdl_opts="--relax"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L gtwizard_ultrascale_v1_7_9 -L xil_defaultlib -L blk_mem_gen_v8_4_4 -L xdma_v4_1_8 -L xlconstant_v1_1_7 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_22 -L axi_vip_v1_1_8 -L gigantic_mux -L xlconcat_v2_1_4 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SoC xil_defaultlib.SoC xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SoC -key {Behavioral:sim_1:Functional:SoC} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d7be.protoinst" -protoinst "protoinst_files/bd_5c78.protoinst" -protoinst "protoinst_files/SoC.protoinst" -log simulate.log
}
